...
class CurvedPipe extends Pipe implements Movable {
  CurvedPipe(String id, String type, String property, String path)
      : super(id, type, property, path);

  CurvedPipe.fromTile(Tile tile) : super.fromTile(tile);
      ...
      case Properties.CURVED_ZERO_ZERO:
        ...
        if (thisX > previousX) {
          ...
          GameRepository.instance.path.cubicTo(
              thisX -  GameRepository.instance.moveUnit, thisY, thisX, thisY, thisX, thisY -  GameRepository.instance.moveUnit);
        } else {
          // GO TO LEFT
